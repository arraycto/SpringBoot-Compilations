 ...
 * 百度音箱自定义技能服务  语音留言播放
 */
@Service("voiceMessageDuerosCustomSkillsServiceImpl")
public class VoiceMessageDuerosCustomSkillsServiceImpl extends AbsCustomSkillsService {
    String base64Security = "eda1782204cf41efaca1e051ccc610be62acdcf24c09f011f343583c41cfb93f";
    private static Logger logger = LoggerFactory.getLogger(VoiceMessageDuerosCustomSkillsServiceImpl.class);
