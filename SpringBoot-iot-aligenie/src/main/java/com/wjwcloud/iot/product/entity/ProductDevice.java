package com.wjwcloud.iot.product.entity;
...
public class ProductDevice extends AbstructBaseEntity<Long> implements Serializable {
	private static final long serialVersionUID = 1L;
	public final static String TABLE_NAME = "base_product_device";
