package com.wjwcloud.drools.controller;

import com.wjwcloud.drools.model.Address;
import com.wjwcloud.drools.model.fact.AddressCheckResult;
import com.wjwcloud.drools.service.ReloadDroolsRulesService;
...
//        KieSession kieSession = ReloadDroolsRulesService.kieContainer.getKieBase().newKieSession();
//        rules.reload();
//        KieSession kieSession = ReloadDroolsRulesService.kieContainer.getKieBase().newKieSession();
